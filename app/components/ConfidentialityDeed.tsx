...
export default function ConfidentialityDeed({
  ...
  return (
    <div className="max-h-[600px] overflow-y-auto p-8 bg-gray-100 font-serif text-gray-800 leading-relaxed rounded-lg">
      <h1 className="text-xl font-bold text-amber-600 mb-6 text-center">
        CONFIDENTIALITY DEED
      </h1>
      <p className="mb-4">THIS DEED is made the day of {today}</p>
      <p className="mb-4">
        BETWEEN: LOAD LINK AUSTRALIA PTY LIMITED (ACN 661 824 175) of Unit
        44/211 Brisbane Road Biggera Waters, Queensland 4216 and AJK ENGINES PTY
        LIMITED (ACN 789 632 145) of Unit 44/211 Brisbane Road Biggera Waters,
        Queensland 4216, (&quot;Disclosing Party&quot;); and{" "}
        {companyName || "[Your Company]"} (ACN {acn || "___"}) of{" "}
        {street || "___"}, {state || "___"} {postcode || "___"}{" "}
        (&quot;Recipient&quot;).
      </p>
      ...
      <p className="mb-2 font-bold">
        ...
        Related Bodies Corporate who have an interest in, or who are the subject
      ...
      <ul className="list-[lower-alpha] pl-6 space-y-2 mb-4">
        ...
        <li>
          The fact that discussions have already occurred between the parties in
          relation to a possible Permitted Transaction and that further such
      ...
      <ul className="list-[lower-alpha] pl-6 space-y-2 mb-4">
        ...
        <li>
          Which was known to or by the Recipient at the time of first disclosure
          to it and was not acquired directly or indirectly from the Disclosing
          Party;
        </li>
        <li>
          Which the Recipient receives from a third party, provided that as far
          as the Recipient is aware (without the need for enquiry) the
      ...
      <p className="mb-2 font-bold">
        ...
        summary or other material derived or produced partly or wholly from any
      ...
      <p className="mb-2 font-bold">
        ...
        legal, financial and other expert advisers and agents of the Recipient.
      </p>
      <p className="mb-2 font-bold">
      ...
      <p className="mb-4 font-bold">
        ...
        the Disclosing Party and the Recipient and/or their respective Bodies
        Corporate pursuant to which the Recipient or any of its Related Bodies
        Corporate lends monies to or participates in any commercial transaction
        with the Disclosing Party or any of its Related Bodies Corporate.
      </p>
      <p className="mb-2">
      ...
      <ul className="list-[lower-alpha] pl-6 space-y-2 mb-4">
        ...
        <li>
          Not to reproduce or record in any form or use any of the Confidential
        ...
        <li>
          Not to use or appropriate any of the Confidential Information for its
          own benefit or gain or for any purpose except for the Permitted
        ...
        <li>
          To ensure that its Representatives are aware that they are obliged to
          treat any Confidential Information received by them in the same manner
          as if they were a party to this Deed;
        </li>
        <li>
          To ensure that its Representatives and Related Bodies Corporate comply
          with the Recipient&apos;s obligations under this Deed as if each
        ...
        <li>
          To promptly take all reasonable steps, at its own expense, to prevent
          or stop any actual or suspected breach of this Deed.
        </li>
      </ul>
      ...
      <p className="mb-2">
        <strong>7.1</strong> Upon the earlier of completion or discontinuance of
        the Permitted Purpose or request by the Disclosing Party, the Recipient
        must promptly return to the Disclosing Party (or destroy if the
        Disclosing Party so directs) all documents and other materials (whether
        originals, copies or in electronic form) within the custody, power or
        control of the Recipient which contain any Confidential Information.
      </p>
      <p className="mb-2">
      ...
      <p className="mb-4">
        <strong>7.2</strong> Return, destruction or retention of Confidential
        Information in accordance with this Clause 7 does not release the
        Recipient from its obligations under this Deed.
      </p>
      ...
      <p className="mb-2">
        ...
        indemnified each of the Beneficiaries from and against all claims,
      ...
      <p className="mb-2">
        <strong>11.2</strong> The indemnity given by the Recipient in this
        Clause 11:
      </p>
      <ul className="list-[lower-alpha] pl-6 space-y-2 mb-4">
        <li>
          Is for the benefit of each of the Beneficiaries. The indemnity may be
          enforced by the Disclosing Party on behalf of itself and the other
      ...
      <p className="mb-4">
        ...
        breach of this Deed and that subject to the court&apos;s discretion (and
      ...
      <ul className="list-[lower-alpha] pl-6 space-y-2 mb-4">
        <li>
          Must be in writing addressed to the intended recipient at the address
      ...
      <p className="mb-1">{companyName || "[Your Company]"}</p>
      <p className="mb-1">
        {street || "___"}, {state || "___"} {postcode || "___"}
      </p>
      ...
      <p className="text-xs text-gray-500 mt-8 italic">
        This deed is generated dynamically based on your onboarding details and
        reflects the full legal agreement between parties. Please ensure all
        fields are accurate before signing.
      </p>
    </div>
  );
}
